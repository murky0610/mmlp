...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2021 at 11:04 PM
...
INSERT INTO `customers` (`username`, `email`, `password`, `phone`, `address`, `Points`, `id`) VALUES
('JC', 'jcwarain@gmail.com', '$2y$10$mxWqc/B2cbtbmxw1BsjY3uUo2haXEVTdZKIz0CVUJKQvQd62wxajG', NULL, NULL, 0, 0);
...
--
ALTER TABLE `food`
  MODIFY `food_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `tickets`
  MODIFY `ticket_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252;
